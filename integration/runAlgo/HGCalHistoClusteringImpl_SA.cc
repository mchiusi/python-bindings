...
// =======================================================================================================================================================
void HGCalHistoClusteringImplSA::runAlgorithm( const l1thgcfirmware::HGCalLinkTriggerCellSAPtrCollection& linkData) //, l1thgcfirmware::HGCalClusterSAPtrCollection& clusterSums )
{
//   std::cout << "---------------------------------------" << std::endl;
