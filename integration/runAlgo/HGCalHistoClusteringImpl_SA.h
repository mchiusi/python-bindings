...
// simplified top level class for the Stage-2 HGCAL emulator
...
public:
  ...
  virtual void runAlgorithm( const l1thgcfirmware::HGCalLinkTriggerCellSAPtrCollection& linksData )                                // , l1thgcfirmware::HGCalClusterSAPtrCollection& clusterSums );
